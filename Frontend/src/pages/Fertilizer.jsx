...
import { Sprout, Wind, Droplets, ThermometerSun, Activity, CheckCircle2, AlertCircle, TrendingUp, Zap, Leaf, Info } from "lucide-react";
      ...
      <section className="max-w-[1600px] mx-auto px-6 pt-8 space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1 border-l-4 border-[#3A4D39] pl-6 py-2">
              ...
              <p className="text-[#4F6F52] font-medium mt-2 text-lg">
                Monitor nutrient composition, environmental conditions, and air quality in real-time.
              </p>
            </div>
            <div className="px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-green-600" />
                <span className="font-bold text-green-700 text-sm">All Systems Optimal</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col bg-white rounded-3xl shadow-lg shadow-[#3A4D39]/5 border border-[#3A4D39]/10 overflow-hidden hover:shadow-xl transition-shadow">
            <div className="px-6 py-5 border-b border-[#ECE3CE] bg-gradient-to-r from-[#FAF9F6] to-[#ECE3CE]/20 flex items-center gap-3">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-bold text-[#3A4D39]">NPK Composition</h2>
                <p className="text-xs text-[#739072] font-medium">Essential plant macronutrients</p>
              </div>
              <div className="text-right">
                <p className="text-xs font-bold text-[#3A4D39] uppercase">Balanced</p>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 min-h-[350px]">
              ...
              >
                <PieChart>
                  <ChartTooltip content={<ChartTooltipContent hideLabel className="bg-white border-[#ECE3CE]" />} />
                  <Pie
                    data={pieChartData}
                    dataKey="visitors"
                    innerRadius={70}
              ...
              <div className="w-full mt-6 space-y-3 border-t border-[#ECE3CE] pt-6">
                {pieChartData.map((item) => (
                  <div key={item.browser} className="flex items-center justify-between p-2 bg-[#FAF9F6] rounded-lg hover:bg-[#ECE3CE]/30 transition-colors">
                    <div className="flex items-center gap-3 flex-1">
                      <div className="w-4 h-4 rounded-full shadow-sm" style={{ backgroundColor: item.fill }} />
                      <span className="text-sm font-bold uppercase text-[#3A4D39]">{item.browser}</span>
                    </div>
                    <div className="text-right">
                      <span className="text-sm font-black text-[#3A4D39]">{item.visitors}mg/L</span>
                      <span className="text-xs text-[#739072] ml-2">({((item.visitors / total) * 100).toFixed(1)}%)</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-white to-orange-50/30 rounded-3xl shadow-lg shadow-orange-200/20 border border-orange-200/30 p-8 flex flex-col justify-between h-full relative overflow-hidden group hover:shadow-xl transition-all">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-[#3A4D39]">Temperature</h2>
                    <p className="text-xs text-[#739072] font-semibold uppercase tracking-wider">Real-time Monitor</p>
                  </div>
                </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-8 relative z-10">
                <div className="text-center space-y-3">
                  <span className="text-8xl font-black text-[#3A4D39] tracking-tighter leading-none">
                    30<span className="text-4xl text-orange-600 align-top relative top-1">°</span>
                  </span>
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-xs text-[#739072] font-medium">Ideal for most plants: 25-35°C</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 bg-gradient-to-br from-white to-blue-50/30 rounded-3xl shadow-lg shadow-blue-200/20 border border-blue-200/30 p-6 flex flex-col justify-between hover:shadow-xl transition-all group">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-[#3A4D39]">Humidity</h2>
                      <p className="text-xs text-[#739072] font-medium">Air moisture level</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-3xl font-black text-[#3A4D39]">60<span className="text-lg text-[#739072]">%</span></span>
              ...
              <div className="flex-1 bg-gradient-to-br from-white to-cyan-50/30 rounded-3xl shadow-lg shadow-cyan-200/20 border border-cyan-200/30 p-6 flex flex-col justify-between hover:shadow-xl transition-all group">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-[#3A4D39]">Soil Moisture</h2>
                      <p className="text-xs text-[#739072] font-medium">Ground water content</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-3xl font-black text-[#3A4D39]">80<span className="text-lg text-[#739072]">%</span></span>
        ...
        <div className="bg-white rounded-3xl shadow-lg shadow-[#3A4D39]/5 border border-[#3A4D39]/10 overflow-hidden hover:shadow-xl transition-all">
          <div className="px-8 py-6 border-b border-[#ECE3CE] bg-gradient-to-r from-[#FAF9F6] to-[#ECE3CE]/20 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg font-bold text-[#3A4D39]">Air Quality & Gas Analysis</h2>
                <p className="text-xs text-[#739072] font-medium">6 Key atmospheric compounds</p>
              </div>
            </div>
            <span className="px-4 py-2 bg-green-100 text-green-700 rounded-full text-xs font-bold uppercase">Healthy</span>
          </div>
          
          <div className="p-8">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
              {GAS_DATA.map((gas) => (
                <div key={gas.type} className="flex justify-center transform hover:scale-105 transition-transform">
                  <GasFlag
                    gas={gas.type}
        ...
        <div className="border-t border-[#3A4D39]/10 pt-8 pb-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            <div>
              <p className="text-xs font-bold text-[#739072] uppercase tracking-wide">Last Update</p>
              <p className="text-sm font-bold text-[#3A4D39] mt-1">Just now</p>
            </div>
            <div>
              <p className="text-xs font-bold text-[#739072] uppercase tracking-wide">System Status</p>
              <p className="text-sm font-bold text-green-600 mt-1">All Sensors Active</p>
            </div>
            <div>
              <p className="text-xs font-bold text-[#739072] uppercase tracking-wide">Next Check</p>
              <p className="text-sm font-bold text-[#3A4D39] mt-1">In 5 minutes</p>
            </div>
          </div>
        </div>
