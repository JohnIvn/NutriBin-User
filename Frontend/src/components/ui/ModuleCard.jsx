...
export default function ModuleCard({ title, icon: Icon, offline = false, subtext = "Hardware Module", onClick }) {
      ...
      <div className="shrink-0 pl-2">
        {offline ? (
          ...
          <div className="flex items-center gap-1.5 px-2 py-1 bg-[#4F6F52]/5 rounded-md border border-[#4F6F52]/10 group-hover:bg-[#4F6F52] group-hover:border-[#4F6F52] transition-colors">
            ...
            <span className="text-[10px] font-bold uppercase text-[#4F6F52] tracking-wide group-hover:text-white">
              Active
            </span>
          </div>
        )}
